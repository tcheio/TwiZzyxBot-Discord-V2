...
module.exports = {
    ...
    execute(client) {
        ...
        tabAllStream = [" 🐺LG UHC "," 🍥NARUTO UHC "," 👺DEMON SLAYER UHC "," ✂️KLK UHC `ou` ✂️KLK UHC V2 "," 🃏EIGHTY SIX UHC "," ☠️DEATH NOTE UHC ",
                        " 🔎SHERLOCK UHC "," 🏴‍☠️ONE PIECE UHC "," 💥THE BOYS UHC "," ⚔️ATTACK ON TITAN UHC `ou` ⚔️AOT UHC "," 🧪FMA UHC ", " 🏰SKY DEFENDER "," 👹JJK UHC "," 🤡FDP UHC `ou` 🤡DAWA UHC"," 🪄MADOKA UHC "," ⛏️SURVIE HARDCORE `ou` 🪓SURVIE HARDCORE ","\n:video_game:**__Multigaming:__**"," ⚽INAZUMA ELEVEN 3: Les Ogres attaquent "," ⚽INAZUMA ELEVEN GO STRIKERS 2013 ",
                        " 🔎AMONG US "," 🖥️CODE LYOKO TIME ", " 🦇Batman Arkham Asylum "," 🍌MARDI Z*ZI ", " 📺TWIZZYX DIRECT "];
